...
class DS3231
{
	public:
		...
		char	*getTimeStr(Time, uint8_t format=FORMAT_LONG);
		char	*getDateStr(uint8_t slformat=FORMAT_LONG, uint8_t eformat=FORMAT_LITTLEENDIAN, char divider='.');
		char	*getDateStr(Time, uint8_t slformat=FORMAT_LONG, uint8_t eformat=FORMAT_LITTLEENDIAN, char divider='.');
		const char	*getDOWStr(uint8_t format=FORMAT_LONG);
		const char	*getDOWStr(Time, uint8_t format=FORMAT_LONG);
		const char	*getMonthStr(uint8_t format=FORMAT_LONG);
		const char	*getMonthStr(Time, uint8_t format=FORMAT_LONG);
