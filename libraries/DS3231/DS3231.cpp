...
char *DS3231::getTimeStr(uint8_t format)
{
    Time t;
    t=getTime();
	return getTimeStr(t, format);
}

char *DS3231::getTimeStr(Time t, uint8_t format)
{
...
char *DS3231::getDateStr(uint8_t slformat, uint8_t eformat, char divider)
{
    Time t;
    t=getTime();
    return (getDateStr(t, slformat, eformat, divider));
}

char *DS3231::getDateStr(Time t, uint8_t slformat, uint8_t eformat, char divider)
{
	int yr, offset;
...
const char *DS3231::getDOWStr(uint8_t format)
{
    Time t;
    t=getTime();
    return getDOWStr(t, format);
}

const char *DS3231::getDOWStr(Time t, uint8_t format)
{
...
const char *DS3231::getMonthStr(uint8_t format)
{
    Time t;
    t=getTime();
    return getMonthStr(t, format);
}

const char *DS3231::getMonthStr(Time t, uint8_t format)
{
